		...
		for(int i = 0; i < registros02; i ++){
            ...
            if(bandera == 0){
                ...
                if(bandera == 0){
                    ...
                    /*lista[i].codigo = codigo02;
                    lista[i].nombre = nombre02;
                    lista[i].puesto = puesto02;
                    lista[i].departamento = departamento02;
                    lista[i].salario = salario02;*/
